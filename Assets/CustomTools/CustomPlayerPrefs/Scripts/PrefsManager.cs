namespace CustomTools.CustomPlayerPrefs.Scripts
{
    ...
    public static class PrefsManager
    {
        ...
        public static SerializedPrefs Prefs
        {
            get
            {
                return _Prefs;
        ...
        public static void SetIntPrefs(this int value, string key)
        {
            ...
            else
            {
                ...
                int index = _Prefs.IntegerPrefs.IndexOf(a => a.Key == key);
        ...
        public static int GetIntPrefs(this string key)
        {
        ...
        public static float GetFloatPrefs(this string key)
        {
        ...
        public static string GetStringPrefs(this string key)
        {
        ...
        public static Vector3 GetVector3Prefs(this string key)
        {
        ...
        public static Quaternion GetQuaternionPrefs(this string key)
        {
